        ...
        <div className="fixed z-20 h-screen left-0 w-screen bg-black/50 flex justify-center items-center">
          <div className="z-10 w-[600px] h-[80%] bg-white rounded-xl">
                <div className="flex justify-between px-4 py-2 border-b-[1px]">
                    ...
                    <button onClick={handleProfileUpdate} className="bg-blue-500 text-white px-4 h-min py-1 rounded-full">Save</button>
                </div>
                    ...
                    <div className="h-52 w-full relative">
                        ...
                        <div className="absolute inset-0 flex justify-center items-center">
                            <label htmlFor="coverImage" className="cursor-pointer">
                                <svg className="w-12 h-12 p-3 rounded-full backdrop-blur-sm text-gray-500 dark:text-gray-700" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
