...
function CreatePost({setPosts, parentPost, setPublishPost}){
    ...
    return(
        <div className="z-20 w-screen h-screen left-0 bottom-0 fixed top-0 bg-black/20 flex justify-center border-2">
            ...
            h-min border-[1px] mt-12 rounded-xl max-w-[620px]">
            <button className="mt-5 mb-2 mx-4 sticky top-5 bg-white p-1 border-2" onClick={() => setPublishPost({publish: false})}>Close</button>
            {parentPost &&
            <div className="pt-3 mx-4 flex gap-2">
